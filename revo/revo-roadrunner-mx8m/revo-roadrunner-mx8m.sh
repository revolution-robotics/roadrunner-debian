...
declare -r G_LINUX_KERNEL_GIT=https://github.com/revolution-robotics/toradex-linux-imx.git
...
declare -r G_LINUX_KERNEL_BRANCH=toradex_5.15-2.0.x-imx
declare -r G_LINUX_KERNEL_REV=167112ffcd8c4864cb520931fafeeba1b5da1230
declare -r G_LINUX_KERNEL_DEF_CONFIG=toradex_defconfig
declare -r G_LINUX_DTB='
...
declare -r BUILD_IMAGE_TYPE=Image
if test ."$BUILD_IMAGE_TYPE" = .'uImage'; then
    declare -r UIMAGE_LOADADDR=0x80800000
fi
declare -r KERNEL_BOOT_IMAGE_SRC=arch/arm64/boot/
declare -r KERNEL_DTB_IMAGE_PATH=arch/arm/boot/dts/freescale
...
# WiFi firmware
declare -r G_FW_SRC_DIR=${DEF_SRC_DIR}/firmware
