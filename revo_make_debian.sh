...
declare -r G_USER_PACKAGES="avahi-daemon bash-completion bc binutils cockpit cockpit-networkmanager curl dnsutils git gpiod jq libsystemd-dev lm-sensors lsb-release openvpn network-manager-openvpn pciutils python3-asteval python3-cryptography python3-dateutil python3-libgpiod python3-lxml python3-pip python3-psutil python3-serial python3-websocket python3-websockets python3-zmq screen sqlite3 sudo sysstat tmux traceroute u-boot-tools wireguard-tools zram-tools"
