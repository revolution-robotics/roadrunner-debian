...
declare -r G_USER_MINIMAL_PACKAGES="avahi-daemon bash-completion bc binutils  curl debsecan dnsutils git gpiod inetutils-ping jq libsystemd-dev libzmq3-dev libzmq5 lsb-release nlohmann-json3-dev openvpn podman pciutils pkgconf python3-asteval python3-cryptography python3-dateutil python3-libgpiod python3-lxml python3-pip python3-psutil python3-serial python3-websocket python3-websockets python3-zmq sudo time u-boot-tools uuid-runtime wget wireguard-tools zram-tools zstd"
